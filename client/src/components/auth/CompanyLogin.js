...
import { companylogin } from '../../actions/company_auth';

const CompanyLogin = ({ companylogin, isAuthenticated }) => {
  ...
  return (
    <section className="container">
      ...
      <p className="my-1">
        Don't have an account? <Link to="/companyregister">Sign Up</Link>
      </p>
    </section>
  );
};
